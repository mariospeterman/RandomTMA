...
var WalletsListManager = class {
  constructor(options) {
    ...
    this.walletsListSource = (_a2 = options === null || options === void 0 ? void 0 : options.walletsListSource) !== null && _a2 !== void 0 ? _a2 : "https://raw.githubusercontent.com/ton-blockchain/wallets-list/main/wallets-v2.json";
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const response = yield this.provider.sendRequest(sendTransactionParser.convertToRpcRequest(Object.assign(Object.assign({}, tx), {
        ...
        messages: messages.map((_a2) => {
          var { extraCurrency } = _a2, msg = __rest(_a2, ["extraCurrency"]);
