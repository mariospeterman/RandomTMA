import {
  require_dist,
  require_dist2
} from "./chunk-LEWR5Y2S.js";
import "./chunk-A4A7MCVU.js";
import {
  __commonJS
  ...
  "node_modules/ton/dist/client/TonClient.js"(exports) {
    ...
    function parseStackEntry(s) {
      switch (s["@type"]) {
        ...
        case "tvm.stackEntryCell":
          return { type: "cell", cell: ton_core_1.Cell.fromBase64(s.cell) };
    ...
    function parseStackItem(s) {
      if (s[0] === "num") {
        ...
        return { type: "cell", cell: ton_core_1.Cell.fromBoc(Buffer.from(s[1].bytes, "base64"))[0] };
      } else if (s[0] === "slice") {
        return { type: "slice", cell: ton_core_1.Cell.fromBoc(Buffer.from(s[1].bytes, "base64"))[0] };
      } else if (s[0] === "builder") {
        return { type: "builder", cell: ton_core_1.Cell.fromBoc(Buffer.from(s[1].bytes, "base64"))[0] };
...
// node_modules/ton/dist/elector/ElectorContract.js
var require_ElectorContract = __commonJS({
  "node_modules/ton/dist/elector/ElectorContract.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var FrozenDictValue = {
      ...
      parse(src) {
        const address = new ton_core_1.Address(-1, src.loadBuffer(32));
    ...
    var ElectorContract = class _ElectorContract {
      constructor() {
        this.address = ton_core_1.Address.parseRaw("-1:3333333333333333333333333333333333333333333333333333333333333333");
      }
      ...
      async getPastElectionsList(provider) {
        ...
        const electionsListRaw = new ton_core_1.TupleReader(res.stack.readLispList());
        const elections = [];
      ...
      async getPastElections(provider) {
        ...
        const electionsRaw = new ton_core_1.TupleReader(res.stack.readLispList());
        const elections = [];
        while (electionsRaw.remaining > 0) {
          ...
          const frozenData = frozenDict.beginParse().loadDictDirect(ton_core_1.Dictionary.Keys.Buffer(32), FrozenDictValue);
      ...
      async getElectionEntities(provider) {
        ...
        const cell = ton_core_1.Cell.fromBoc(account.state.data)[0];
        ...
        const entitiesData = sc.loadDict(ton_core_1.Dictionary.Keys.Buffer(32), EntitiesDictValue);
        let entities = [];
        if (entitiesData) {
      ...
      async getComplaints(provider, electionId) {
        const b = new ton_core_1.TupleBuilder();
        b.writeNumber(electionId);
        const res = await provider.get("list_complaints", b.build());
        if (res.stack.peek().type === "null") {
          return [];
        }
        const complaintsRaw = new ton_core_1.TupleReader(res.stack.readLispList());
        const results = [];
        while (complaintsRaw.remaining > 0) {
          ...
          const rewardAddress = new ton_core_1.Address(-1, Buffer.from(unpackedComplaints.readBigNumber().toString(16), "hex"));
          ...
          const votes = [];
          const votersListRaw = new ton_core_1.TupleReader(completeUnpackedComplaint.readLispList());
...
// node_modules/ton/dist/config/ConfigParser.js
var require_ConfigParser = __commonJS({
  "node_modules/ton/dist/config/ConfigParser.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function configParseMasterAddress(slice) {
      if (slice) {
        return new ton_core_1.Address(-1, slice.loadBuffer(32));
      } else {
        return null;
      }
    }
    ...
    function parseValidatorSet(slice) {
      ...
      if (header === 17) {
        ...
        const list = slice.loadDictDirect(ton_core_1.Dictionary.Keys.Uint(16), ValidatorDescriptionDictValue);
        return {
          timeSince,
          timeUntil,
          total,
        ...
        const list = slice.loadDict(ton_core_1.Dictionary.Keys.Uint(16), ValidatorDescriptionDictValue);
        return {
          timeSince,
          timeUntil,
          total,
    ...
    function parseBridge(slice) {
      const bridgeAddress = new ton_core_1.Address(-1, slice.loadBuffer(32));
      const oracleMultisigAddress = new ton_core_1.Address(-1, slice.loadBuffer(32));
      const oraclesDict = slice.loadDict(ton_core_1.Dictionary.Keys.Buffer(32), ton_core_1.Dictionary.Values.Buffer(32));
      const oracles = /* @__PURE__ */ new Map();
      for (const [local, remote] of oraclesDict) {
        oracles.set(new ton_core_1.Address(-1, local).toString(), remote);
      }
    ...
    function configParse5(slice) {
      ...
      if (magic === 1) {
        const blackholeAddr = slice.loadBit() ? new ton_core_1.Address(-1, slice.loadBuffer(32)) : null;
    ...
    function configParse18(slice) {
      ...
      return slice.loadDictDirect(ton_core_1.Dictionary.Keys.Buffer(4), StoragePricesDictValue).values();
    }
    ...
    function configParse12(slice) {
      ...
      const wd = slice.loadDict(ton_core_1.Dictionary.Keys.Uint(32), WorkchainDescriptorDictValue);
      if (wd) {
        return wd;
      }
    ...
    function loadConfigParams(configBase64) {
      const comfigMap = ton_core_1.Cell.fromBase64(configBase64).beginParse().loadDictDirect(ton_core_1.Dictionary.Keys.Int(32), ton_core_1.Dictionary.Values.Cell());
      return comfigMap;
    }
...
// node_modules/ton/dist/utils/fees.js
var require_fees = __commonJS({
  "node_modules/ton/dist/utils/fees.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function computeMessageForwardFees(msgPrices, cell) {
      let msg = (0, ton_core_1.loadMessageRelaxed)(cell.beginParse());
      let storageStats = { bits: 0, cells: 0 };
      if (msg.init) {
        const rawBuilder = new ton_core_1.Cell().asBuilder();
        (0, ton_core_1.storeStateInit)(msg.init)(rawBuilder);
